...
public class IssuesTest extends PerfTestCase {
  ...
  public void scan_100_files_1000_issues_tracking() throws IOException {
    ...
    assertDurationAround(collector, Long.valueOf(prof.getProperty("IssueTrackingDecorator")), 2131L);
    ...
    assertDurationAround(collector, Long.valueOf(prof.getProperty("IssueTrackingDecorator")), 3804L);
