...
public class TempFolderExtension implements ServerExtension, Startable {

  private static final Logger LOG = LoggerFactory.getLogger(TempFolderExtension.class);
