...
public class BackupTest {
  ...
  public void should_backup_settings_xml_contains_only_database_properties() {
    ...
    assertThat(settings).doesNotContain("sonar.web.deployDir")
      ...
      .doesNotContain("PWD")
    ;
    assertThat(settings).contains("sonar.role.admin.TRK.defaultGroups")
      .contains("sonar.role.user.TRK.defaultGroups")
      .contains("sonar.role.codeviewer.TRK.defaultGroups")
      .contains("sonar.role.admin.VW.defaultGroups")
      .contains("sonar.role.user.VW.defaultGroups")
      .contains("sonar.role.codeviewer.VW.defaultGroups")
      .contains("sonar.role.admin.SVW.defaultGroups")
      .contains("sonar.role.user.SVW.defaultGroups")
      .contains("sonar.role.codeviewer.SVW.defaultGroups")
