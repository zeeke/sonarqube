...
@RunWith(Suite.class)
@Suite.SuiteClasses({
  LinksTest.class, MavenTest.class, DesignUITest.class, CrossProjectDuplicationsTest.class, DuplicationsTest.class, SourceFiltersTest.class, CoverageExclusionsTest.class,
